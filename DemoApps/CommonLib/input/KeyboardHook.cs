...
namespace Phoebit.Input
{
    ...
    public class KeyboardHook
    {
        ...
        public static String Keycode2String(uint keyCode)
        {
            ...
            uint lScanCode = MapVirtualKeyEx(keyCode, 0, HKL);
            ...
            int relevantKeyCountInBuffer = ToUnicodeEx(keyCode, lScanCode, bKeyState, sbString, sbString.Capacity, (uint)0, HKL);
